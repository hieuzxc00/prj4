								...
								<table id="categoryList"
									...
									<thead>
										<tr role="row">
											...
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
												aria-label="Browser: activate to sort column ascending">Bar Code</th>
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
									...
									<tbody>
										<c:forEach var="product" items="${products }">
											<tr role="row" class="odd">
												...
												<td>
													<img src="${pageContext.request.contextPath}/admin/product/barcode/${product.id }" width="120" height="40">
												</td>
												<td>${product.name }</td>
