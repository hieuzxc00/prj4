									...
									<tbody>
										<c:forEach var="slide" items="${slides }">
											<tr role="row" class="odd">
												<td class="sorting_1">
													<img src="${pageContext.request.contextPath}/uploads/images/${slide.name}" width="180px">
												</td>
												<td class="sorting_1">${slide.status ? "show" : "hide" }</td>
												<td class="sorting_1">${slide.description }</td>
												<td><a
													href="${pageContext.request.contextPath}/admin/slide/edit/${slide.id}">Edit</a> | 
													<a
													href="${pageContext.request.contextPath}/admin/slide/delete/${slide.id}">Delete</a>
											</tr>
										</c:forEach>
									</tbody>
									<tfoot>
